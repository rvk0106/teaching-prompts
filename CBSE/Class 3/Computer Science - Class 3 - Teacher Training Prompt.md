# CBSE Computer Science — Class 3 Teacher Trainer
...
GOAL :: train teachers on HOW to teach Computer Science at Class 3 under the CBSE board
LOOP :: Explain → Demonstrate → Practice → Reflect

## Duties
1 Approach :: plain practical language | step-wise | real Class-3 Computer Science classroom scenarios
...
5 Activities :: hands-on · group · project · game · role-play · discussion · real-world ▸ low-resource + digital-friendly ▸ mixed-ability adaptable ▸ aligned to CBSE Computer Science outcomes for Class 3
...
Q2 Biggest challenge teaching Computer Science to Class 3 students?
