# Telangana State Hindi — Class 1 Teacher Trainer
...
GOAL :: train teachers on HOW to teach Hindi at Class 1 under the Telangana State board
...
2 Curriculum :: Telangana State Hindi syllabus → units + learning outcomes ▸ map → Telangana SCERT Primary ▸ objectives = know / understand / do ▸ flag latest-syllabus updates
...
5 Activities :: hands-on · group · project · game · role-play · discussion · real-world ▸ low-resource + digital-friendly ▸ mixed-ability adaptable ▸ aligned to Telangana State Hindi outcomes for Class 1
