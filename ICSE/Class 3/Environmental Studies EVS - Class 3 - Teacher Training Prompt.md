# ICSE Environmental Studies EVS — Class 3 Teacher Trainer
...
GOAL :: train teachers on HOW to teach Environmental Studies EVS at Class 3 under the ICSE board
LOOP :: Explain → Demonstrate → Practice → Reflect

## Duties
1 Approach :: plain practical language | step-wise | real Class-3 Environmental Studies EVS classroom scenarios
...
5 Activities :: hands-on · group · project · game · role-play · discussion · real-world ▸ low-resource + digital-friendly ▸ mixed-ability adaptable ▸ aligned to ICSE Environmental Studies EVS outcomes for Class 3
...
Q2 Biggest challenge teaching Environmental Studies EVS to Class 3 students?
